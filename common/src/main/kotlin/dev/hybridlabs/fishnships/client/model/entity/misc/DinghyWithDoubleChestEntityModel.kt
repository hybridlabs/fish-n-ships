...
class DinghyWithDoubleChestEntityModel<T : DinghyWithDoubleChestEntity>() :
    GeoModel<T>() {
    ...
    companion object {
        private val DEFAULT_MODEL =
            CommonClass.locate("geo/entity/dinghy/dinghy_with_double_chest.geo.json")
        private val ALT_MODEL =
            CommonClass.locate("geo/entity/dinghy/alt_dinghy_with_double_chest.geo.json")

        private val OAK_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/oak_dinghy_with_double_chest.png")
        private val SPRUCE_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/spruce_dinghy_with_double_chest.png")
        private val BIRCH_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/birch_dinghy_with_double_chest.png")
        private val JUNGLE_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/jungle_dinghy_with_double_chest.png")
        private val ACACIA_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/acacia_dinghy_with_double_chest.png")
        private val CHERRY_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/cherry_dinghy_with_double_chest.png")
        private val DARK_OAK_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/dark_oak_dinghy_with_double_chest.png")
        private val MANGROVE_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/mangrove_dinghy_with_double_chest.png")
        private val CRIMSON_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/crimson_dinghy_with_double_chest.png")
        private val WARPED_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/warped_dinghy_with_double_chest.png")

        private val ALT_OAK_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_oak_dinghy_with_double_chest.png")
        private val ALT_SPRUCE_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_spruce_dinghy_with_double_chest.png")
        private val ALT_BIRCH_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_birch_dinghy_with_double_chest.png")
        private val ALT_JUNGLE_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_jungle_dinghy_with_double_chest.png")
        private val ALT_ACACIA_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_acacia_dinghy_with_double_chest.png")
        private val ALT_CHERRY_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_cherry_dinghy_with_double_chest.png")
        private val ALT_DARK_OAK_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_dark_oak_dinghy_with_double_chest.png")
        private val ALT_MANGROVE_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_mangrove_dinghy_with_double_chest.png")
        private val ALT_CRIMSON_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_crimson_dinghy_with_double_chest.png")
        private val ALT_WARPED_TEXTURE =
            CommonClass.locate("textures/entity/dinghy/alt_warped_dinghy_with_double_chest.png")
    }
}