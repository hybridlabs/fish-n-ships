...
class SailboatWithChestMenu(type: MenuType<*>, containerId: Int, playerInventory: Inventory, container: Container, rows: Int) :
    ...
    companion object {
        ...
        fun threeRows(containerId: Int, playerInventory: Inventory): SailboatWithChestMenu {
            return SailboatWithChestMenu(
                FSMenuTypes.SAILBOAT_MENU_3ROW.get(),
                containerId,
                playerInventory,
