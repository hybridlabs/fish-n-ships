...
class ShipMenu(type: MenuType<*>, containerId: Int, playerInventory: Inventory, container: Container, rows: Int, val containerData: ContainerData) :
    ...
    companion object {
        ...
        fun threeRows(containerId: Int, playerInventory: Inventory, container: Container, containerData: ContainerData): ShipMenu {
            return ShipMenu(
                FSMenuTypes.SHIP_MENU_3ROW.get(),
                containerId,
                playerInventory,
