...
object FSItems {
    ...
    val OAK_DINGHY_WITH_DOUBLE_CHEST = register("oak_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.OAK,Item.Properties().stacksTo(1))}
    ...
    val CHERRY_DINGHY_WITH_DOUBLE_CHEST = register("cherry_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.CHERRY,Item.Properties().stacksTo(1))}
    ...
    val WARPED_DINGHY_WITH_DOUBLE_CHEST = register("warped_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.WARPED,Item.Properties().stacksTo(1))}
    ...
    val CRIMSON_DINGHY_WITH_DOUBLE_CHEST = register("crimson_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.CRIMSON,Item.Properties().stacksTo(1))}
    ...
    val ACACIA_DINGHY_WITH_DOUBLE_CHEST = register("acacia_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.ACACIA,Item.Properties().stacksTo(1))}
    ...
    val MANGROVE_DINGHY_WITH_DOUBLE_CHEST = register("mangrove_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.MANGROVE,Item.Properties().stacksTo(1))}
    ...
    val JUNGLE_DINGHY_WITH_DOUBLE_CHEST = register("jungle_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.JUNGLE,Item.Properties().stacksTo(1))}
    ...
    val SPRUCE_DINGHY_WITH_DOUBLE_CHEST = register("spruce_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.SPRUCE,Item.Properties().stacksTo(1))}
    ...
    val BIRCH_DINGHY_WITH_DOUBLE_CHEST = register("birch_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.BIRCH,Item.Properties().stacksTo(1))}
    ...
    val DARK_OAK_DINGHY_WITH_DOUBLE_CHEST = register("dark_oak_dinghy_with_double_chest") { DinghyWithDoubleChestItem(DinghyEntity.Type.DARK_OAK,Item.Properties().stacksTo(1))}
