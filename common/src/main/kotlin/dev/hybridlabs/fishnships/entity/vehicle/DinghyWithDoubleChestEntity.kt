...
open class DinghyWithDoubleChestEntity(entityType: EntityType<out DinghyWithDoubleChestEntity>, level: Level) :
    ...
    override fun getDinghyItem(): Item {
        ...
        when (this.variant.ordinal) {
            1 -> item = FSItems.SPRUCE_DINGHY_WITH_DOUBLE_CHEST.get()
            2 -> item = FSItems.BIRCH_DINGHY_WITH_DOUBLE_CHEST.get()
            3 -> item = FSItems.JUNGLE_DINGHY_WITH_DOUBLE_CHEST.get()
            4 -> item = FSItems.ACACIA_DINGHY_WITH_DOUBLE_CHEST.get()
            5 -> item = FSItems.CHERRY_DINGHY_WITH_DOUBLE_CHEST.get()
            6 -> item = FSItems.DARK_OAK_DINGHY_WITH_DOUBLE_CHEST.get()
            7 -> item = FSItems.MANGROVE_DINGHY_WITH_DOUBLE_CHEST.get()
            8 -> item = FSItems.CRIMSON_DINGHY_WITH_DOUBLE_CHEST.get()
            9 -> item = FSItems.WARPED_DINGHY_WITH_DOUBLE_CHEST.get()
            else -> item = FSItems.OAK_DINGHY_WITH_DOUBLE_CHEST.get()
        }
