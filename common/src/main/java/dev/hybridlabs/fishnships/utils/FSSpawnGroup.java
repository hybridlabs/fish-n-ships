package dev.hybridlabs.fishnships.utils;
...
public enum FSSpawnGroup {
    FISH_N_SHIPS_SHIP("ship", 1, true, false, 128);
    ...
    FSSpawnGroup(String id, int spawnCap, boolean peaceful, boolean rare, int immediateDespawnRange) {
